...
import static com.example.medicalhealthanalyser.models.Constants.EMG_TURN_ON;
...
public class EmgSensorActivity extends AppCompatActivity {
...
//            data.addEntry(new Entry(set.getEntryCount(), (float) (Math.random() * 80) + 10f), 0);
        ...
        StartCardView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (startTextView.getText().toString().contentEquals(START)) {
                    Toast.makeText(EmgSensorActivity.this, "started", Toast.LENGTH_SHORT).show();
                    TurnOnSensor();
                } else if (startTextView.getText().toString().contentEquals(STOP)) {
                    Toast.makeText(EmgSensorActivity.this, "STOPPED", Toast.LENGTH_SHORT).show();
                    TurnOffSensor();
                }
            }
        });
    ...
    private void write(byte[] str) {
        ...
        bluetoothChatService.write(EMG_TURN_ON);
    ...
    private void initViews() {
        ...
        lottieAnimationView.setAnimation(R.raw.emg_anim);
    }
