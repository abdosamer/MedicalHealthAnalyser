...
import static com.example.medicalhealthanalyser.models.Constants.ECG_TURN_ON;
...
public class EcgSensorActivity extends AppCompatActivity {
...
//            data.addEntry(new Entry(set.getEntryCount(), (float) (Math.random() * 80) + 10f), 0);
        ...
        StartCardView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (startTextView.getText().toString().contentEquals(START)) {
                    Toast.makeText(EcgSensorActivity.this, "started", Toast.LENGTH_SHORT).show();
                    TurnOnSensor();
                } else if (startTextView.getText().toString().contentEquals(STOP)) {
                    Toast.makeText(EcgSensorActivity.this, "STOPPED", Toast.LENGTH_SHORT).show();
                    TurnOffSensor();
                }
            }
        });
    ...
    private void write(byte[] str) {
        ...
        bluetoothChatService.write(ECG_TURN_ON);
    ...
    private void initViews() {
        ...
        LottieAnimationView lottieAnimationView = findViewById(R.id.lottie_title_anim);
        lottieAnimationView.setAnimation(R.raw.ecg_anim);
    }
